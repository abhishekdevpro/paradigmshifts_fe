...
//               <a href="https://ultraaura.education/home" className="text-blue-600 hover:text-blue-800 font-medium inline-flex items-center">
//                 Learn More
...
//           </div>
//           <div className="mt-auto">
//             <a href="https://novajobs.us/" className="text-blue-600 hover:text-blue-800 font-medium inline-flex items-center">
//               Learn More
//               <svg className="w-4 h-4 ml-1" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
//                 <path strokeLinecap="round" strokeLinejoin="round" d="M9 5l7 7-7 7" />
//               </svg>
    ...
    <div className='relative overflow-hidden'>
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 py-12">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          ...
          {/* UltraAura Card */}
          <div className="bg-white p-8 rounded-lg shadow-lg transform transition-all duration-300 hover:scale-105 hover:shadow-2xl hover:bg-gray-50 flex flex-col h-full">
            <div className="mb-6">
            ...
            <div className="mt-auto">
              <a href="https://ultraaura.education/home" className="text-blue-600 hover:text-blue-800 font-medium inline-flex items-center group">
                Learn More
          ...
          <div className="bg-white p-8 rounded-lg shadow-lg transform transition-all duration-300 hover:scale-105 hover:shadow-2xl hover:bg-gray-50 flex flex-col h-full">
            ...
            <div className="mt-auto">
              <a href="https://novajobs.us/" className="text-blue-600 hover:text-blue-800 font-medium inline-flex items-center group">
                Learn More
                <svg className="w-4 h-4 ml-1 transform transition-transform group-hover:translate-x-1" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
                  <path strokeLinecap="round" strokeLinejoin="round" d="M9 5l7 7-7 7" />
                </svg>
