  ...
  const programs = [
    {
      ...
      description: 'Become part of our mission to create healthier, drug-free workplaces and make a meaningful impact.'
    },
    {
      title: 'Department of Mental Health',
      description: 'Contribute now to make an immediate difference in fostering a safe work.'
    },
    {
      title: 'Kids at Risk',
      description: 'Collaborate with us to build a future of health and safety. Your support will drive transformative opportunities and create a lasting impact.'
    }
  ];
